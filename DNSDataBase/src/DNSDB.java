...
public class DNSDB {
    ...
    private BPlusGeneric<Integer, String> hostNames;
    private BPlusGeneric<String, Integer> ipAddresses;

    private final int BLOCK_SIZE = 1024;
    private final int HOST_NAME_SIZE = 60;
    private final int IP_ADDRESS_SIZE = 32;


    public DNSDB(){
    	hostNames = new BPlusGeneric<Integer, String>(BLOCK_SIZE, IP_ADDRESS_SIZE, HOST_NAME_SIZE);  //int to string.  Takes the block size, key size, value size and a comparator as arguments
    	ipAddresses = new BPlusGeneric<String, Integer>(BLOCK_SIZE, HOST_NAME_SIZE, IP_ADDRESS_SIZE);  //string to int.
    }
    ...
    public void iterateAll(){
    	System.out.println("Printing all pairs in HostNames index:");
    	hostNames.iterateAll();
    }
